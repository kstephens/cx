...
var cx_make_filter =
    function(table_id_) {
      ...
      function pin_width(element) {
        ...
        // style.height = comp_style.height;
        console.log("  %s : %d x %d", element, style.width, style.height);
      }
        /* ERROR:
        pin_size(dom_table); // WTF?
        test.html:1719 dom_window = Window
        test.html:1691   th.cx-column : NaN x NaN
        test.html:1691   th.cx-column : NaN x NaN
        test.html:1691   th.cx-column : NaN x NaN
        test.html:1691   th.cx-column : NaN x NaN
        test.html:1691   th.cx-column : NaN x NaN
        test.html:1687 Uncaught TypeError: Failed to execute 'getComputedStyle' on 'Window': parameter 1 is not of type 'Element'.
          at pin_size (test.html:1687)
        at filter_rows_now (test.html:1627)
        at filter_rows_event (test.html:1650)
        at test.html:1660
        pin_size @ test.html:1687
        filter_rows_now @ test.html:1627
        filter_rows_event @ test.html:1650
        (anonymous) @ test.html:1660
        setTimeout (async)
        filter_rows @ test.html:1659
        onkeyup @ VM11576 test.html:109
        */
