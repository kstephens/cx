...
module CX
  RSpec.describe Stats do
        ...
        expected =
          { :nils => 0,
            ...
            :bins => [[7...Rational(101, 13), { 7 => 1 }],
                      ...
                      [Rational(141, 13)...Rational(151, 13), { 11 => 1 }],
                      [Rational(151, 13)...Rational(161, 13), {}],
                      [Rational(161, 13)...Rational(171, 13), { 13 => 1 }],
        ...
        it "works" do
          expected =
            { :nils => 0,
              ...
              :n_bins => 13,
              :bins_range => 2..22,
              :bins => [[2...Rational(46, 13), { 2 => 5, 3 => 5 }],
                        [Rational(46, 13)...Rational(66, 13), { 4 => 5, 5 => 5 }],
                        [Rational(66, 13)...Rational(86, 13), { 6 => 5 }],
                        [Rational(86, 13)...Rational(106, 13), { 7 => 5, 8 => 5 }],
                        [Rational(106, 13)...Rational(126, 13), { 9 => 5 }],
                        [Rational(126, 13)...Rational(146, 13), { 10 => 5, 11 => 5 }],
                        [Rational(146, 13)...Rational(166, 13), { 12 => 5 }],
                        [Rational(166, 13)...Rational(186, 13), { 13 => 5, 14 => 5 }],
                        [Rational(186, 13)...Rational(206, 13), { 15 => 5 }],
                        [Rational(206, 13)...Rational(226, 13), { 16 => 5, 17 => 5 }],
                        [Rational(226, 13)...Rational(246, 13), { 18 => 4 }],
                        [Rational(246, 13)...Rational(266, 13), { 19 => 4, 20 => 4 }],
                        [Rational(266, 13)..22, { 21 => 4, 22 => 4 }]],
              :value_types => [Integer],
              :value_type => Integer }
        ...
        it "works" do
          expected =
            { :nils => 0,
              ...
              :n_bins => 13,
              :bins_range => 2.0..22.0,
              :bins => [[2.0...3.5384615384615383, { 2.0 => 5, 3.0 => 5 }],
                        [3.5384615384615383...5.076923076923077, { 4.0 => 5, 5.0 => 5 }],
                        [5.076923076923077...6.615384615384615, { 6.0 => 5 }],
                        [6.615384615384615...8.153846153846153, { 7.0 => 5, 8.0 => 5 }],
                        [8.153846153846153...9.692307692307692, { 9.0 => 5 }],
                        [9.692307692307692...11.23076923076923, { 10.0 => 5, 11.0 => 5 }],
                        [11.23076923076923...12.769230769230768, { 12.0 => 5 }],
                        [12.769230769230768...14.307692307692307, { 13.0 => 5, 14.0 => 5 }],
                        [14.307692307692307...15.846153846153845, { 15.0 => 5 }],
                        [15.846153846153845...17.384615384615383, { 16.0 => 5, 17.0 => 5 }],
                        [17.384615384615383...18.923076923076923, { 18.0 => 4 }],
                        [18.923076923076923...20.46153846153846, { 19.0 => 4, 20.0 => 4 }],
                        [20.46153846153846..22.0, { 21.0 => 4, 22.0 => 4 }]],
              :value_types => [Float],
              :value_type => Float }
          a = clean_up!(actual)
          e = clean_up!(expected)
      ...
      describe "integers" do
        ...
        it "works" do
          expected = {
            ...
            :n_bins => 13,
            :bins_range => 12..97,
            :bins => [[12...Rational(241, 13), { 12 => 1, 13 => 1, 14 => 1, 16 => 8, 17 => 2 }],
                      [Rational(241, 13)...Rational(326, 13),
                       { 19 => 3, 20 => 4, 22 => 6, 23 => 5, 25 => 8 }],
                      [Rational(326, 13)...Rational(411, 13), { 26 => 4, 27 => 2, 29 => 5, 30 => 2 }],
                      [Rational(411, 13)...Rational(496, 13), { 32 => 4, 33 => 3, 34 => 3, 36 => 4 }],
                      [Rational(496, 13)...Rational(581, 13),
                       { 40 => 2, 41 => 8, 42 => 4, 43 => 5, 44 => 2 }],
                      [Rational(581, 13)...Rational(666, 13), { 46 => 1, 47 => 4, 49 => 2, 50 => 5 }],
                      [Rational(666, 13)...Rational(751, 13), { 57 => 2 }],
                      ...
                      [Rational(1006, 13)...Rational(1091, 13), { 78 => 1, 80 => 4, 81 => 3, 83 => 3 }],
                      [Rational(1091, 13)...Rational(1176, 13),
                       { 84 => 3, 86 => 2, 87 => 2, 88 => 9, 90 => 1 }],
                      [Rational(1176, 13)..97, { 91 => 2, 93 => 7, 95 => 4, 97 => 1 }]],
            :value_types => [Integer],
            :value_type => Integer,
          }
          verify! actual, expected
            ...
            { :nils => 19,
              ...
              :bins => [[10.271889398044452...16.92016819568598,
                        ...
                        [16.92016819568598...23.568446993327512,
                         { 16.931295781369904 => 4, 20.144134775378916 => 2 }],
                        [23.568446993327512...30.216725790969043,
                         { 24.0778018563041 => 1, 26.790570815426506 => 1, 27.678301829841164 => 1 }],
                        ...
                        [50.16156218389363...56.80984098153515,
                         { 50.688670648984264 => 2, 53.08180530810877 => 1, 55.171210963795794 => 1 }],
    ...
    def verify!(actual, expected)
      ...
      #expect(actual == expected) .to be(true) ; return

      expect(actual).to eq(expected); return

      # expect(diff) .to be_empty ;return
